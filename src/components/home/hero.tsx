	...
	return (
		<section className="relative min-h-screen bg-white overflow-hidden">
			...
			<div className="absolute inset-0">
				...
				<div className="absolute top-20 left-1/4 w-3 h-3 bg-indigo-400 rounded-full animate-ping"></div>
				<div className="absolute bottom-40 right-1/3 w-4 h-4 bg-purple-400 rounded-full animate-pulse"></div>
				<div className="absolute top-1/2 right-20 w-5 h-5 border-2 border-pink-300 rounded-full animate-bounce"></div>
				<div className="absolute top-1/3 left-10 w-32 h-32 border-2 border-indigo-100 rounded-full animate-spin" style={{animationDuration: '30s'}}></div>
				...
				<div className="absolute right-0 top-0 w-1/2 h-full">
					<div
						className={`absolute inset-0 bg-gradient-to-l from-transparent to-white transition-opacity duration-500 ${
				...
				<div className="grid lg:grid-cols-12 gap-12 items-center min-h-[80vh]">
					...
					<div className="lg:col-span-7 space-y-12">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
							<div className="group">
								...
								<p className="text-gray-600 text-sm">Master essential grammar principles</p>
							</div>
							...
							<div className="group">
								...
								<h3 className="text-lg font-bold text-gray-900 mb-2">Writing Skills</h3>
								<p className="text-gray-600 text-sm">Enhance your writing precision</p>
							</div>
							...
							<div className="group">
								...
								<h3 className="text-lg font-bold text-gray-900 mb-2">Language Mastery</h3>
								<p className="text-gray-600 text-sm">Perfect your communication</p>
							</div>
						</div>
						...
						<div className="flex flex-col sm:flex-row gap-6 pt-4">
							<a
								href='/blog'
								className="group relative inline-flex items-center justify-center px-8 py-6 bg-gray-900 text-white rounded-2xl font-bold text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 hover:bg-gray-800 hover:scale-105 overflow-hidden"
							>
							...
							<a
								href='/about'
								className="group inline-flex items-center justify-center px-8 py-6 bg-white text-gray-900 rounded-2xl font-bold text-lg shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-200 hover:border-indigo-300 hover:-translate-y-1"
							>
						...
						<div className="flex items-center space-x-8 pt-8 border-t border-gray-100">
							<div className="text-center">
								...
								<div className="text-sm text-gray-500">Grammar Nerds</div>
							</div>
							<div className="w-px h-8 bg-gray-200"></div>
							<div className="text-center">
								<div className="text-2xl font-bold text-gray-900">800+</div>
								<div className="text-sm text-gray-500">Grammar Guides</div>
							</div>
							<div className="w-px h-8 bg-gray-200"></div>
							<div className="text-center">
								<div className="text-2xl font-bold text-gray-900">Daily</div>
								<div className="text-sm text-gray-500">Language Tips</div>
							</div>
						</div>
					</div>
					...
					<div className="lg:col-span-5">
						<div className="relative">
							...
							{/* Floating elements */}
							<div className="absolute -top-4 -right-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-2xl shadow-xl p-4 animate-bounce">
							...
							{/* Decorative dots */}
							<div className="absolute top-1/4 -left-8 w-4 h-4 bg-indigo-400 rounded-full animate-pulse"></div>
							<div className="absolute top-1/2 -right-6 w-3 h-3 bg-purple-400 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
							<div className="absolute bottom-1/4 -left-6 w-5 h-5 bg-pink-400 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
						</div>
					</div>
				</div>
